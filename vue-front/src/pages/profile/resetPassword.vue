  ...
  <section class="flex justify-center section">
    <form @submit.prevent class="flex flex-col w-full md:w-9/12 lg:w-5/12 form">
      ...
      <p class="mb-4 text-slate-600">
        Here you can change your password. Token administrate to change password expire in 15 minutes, be sure to change before the time.
      </p>
      <div class="field">
        <label for="new_password" class="label">New password</label>
        <input id="new_password" type="password" name="new_password" v-model="newPassword" class="input" placeholder="********" required />
      </div>
      <div class="field">
